(function () {
  ...
  /* =========================
     CONFIG
  ========================= */
  const WHATSAPP_NUMBER = "5571982564207";
  ...
  /* =========================
     DATA: produtos
     - cat deve ser: "Bolos" | "Tortas" | "Trufas" | "Doces"
     - opções (quando existir) aparecem na página do produto
  ========================= */
const PRODUCTS = [
    {
  id: "p01",
  name: "Bolo para aniversário",
  cat: "Bolos",
  price: 120,
  pricing: {
    defaultSize: "Médio",
    bolo: { "Pequeno": 120, "Médio": 160, "Grande": 220 }
  },
  tags: ["aniversarios"],
  desc: `Você escolhe massa, recheios, cobertura e tema. 
         Disponível em três tamanhos para escolher o ideal:
         Pequeno (15 cm), Médio (20 cm) e Grande (25 cm).`,

  imgs: [
    "IMG/bolo aniversario6.jpg",
    "IMG/bolo aniversario7.jpg",
    "IMG/bolo aniversario01.jpg",
    "IMG/bolo aniversario8.jpg"
  ],
  options: [
    { key: "tamanho", label: "Tamanho", type: "select", required: true, choices: ["Pequeno", "Médio", "Grande"] },
    { key: "massa", label: "Massa", type: "select", required: true, choices: ["Baunilha", "Chocolate", "Red Velvet", "Cenoura", "Laranja", "Milho", "Tapioca"] },
    { key: "recheio1", label: "Recheio (1)", type: "select", required: true, choices: ["Chocolate", "Chocolate branco", "Ninho", "Doce de leite", "Morango", "Limão", "Maracujá"] },
    { key: "recheio2", label: "Recheio (2)", type: "select", required: false, choices: ["(sem 2º recheio)", "Chocolate", "Chocolate branco", "Ninho", "Doce de leite", "Morango", "Limão", "Maracujá"], emptyValue: "(sem 2º recheio)" },
    { key: "cobertura", label: "Cobertura", type: "select", required: true, choices: ["Ganache de chocolate", "Ganache chocolate branco", "Chantininho", "Ninho", "Doce de leite", "Brigadeiro"] },
    { key: "tema", label: "Tema (texto)", type: "text", required: false, placeholder: "Ex.: Princesa, Futebol, Minimalista…", maxLen: 40 },
    { key: "restricoes", label: "Opções saudáveis (opcional) (+ R$ 18,00)", type: "multiselect", required: false, max: 3, choices: ["Sem glúten", "Sem lactose", "Sem açúcar"] },
  ],
},
  ...
  // Bolos caseiros
  {
    ...
    pricing: {
      fatia: 10,
      defaultSize: "Médio",
      bolo: { "Pequeno": 45, "Médio": 55, "Grande": 65 }
    },
    tags: ["cafe", "porque"],
    desc: `Bolo simples, fofinho e cheio de sabor.
Disponível em três tamanhos para escolher o ideal:
Pequeno (15 cm), Médio (20 cm) e Grande (25 cm).`,

    imgs: ["IMG/bolo caseiro0.jpg","IMG/bolo caseiro5.jpg", "IMG/bolo caseiro6.jpg", "IMG/bolo caseiro3.jpg"],
    options: [
      { key: "tipo", label: "Formato", type: "select", required: true, choices: ["Bolo", "Fatia"] },
      { key: "tamanho", label: "Tamanho", type: "select", required: false, requiredIf: { key: "tipo", value: "Bolo" }, choices: ["Pequeno", "Médio", "Grande"] },
      { key: "sabor", label: "Sabor", type: "select", required: true, choices: ["Laranja", "Chocolate", "Tapioca", "Milho", "Cenoura"] },
      { key: "restricoes", label: "Opções saudáveis (opcional) (+ R$ 18,00)", type: "multiselect", required: false, max: 3, choices: ["Sem glúten", "Sem lactose", "Sem açúcar"] },
    ],
  },
  ...
  // Bolo vulcão
  {
    ...
    pricing: {
      defaultSize: "Médio",
      bolo: { "Pequeno": 68, "Médio": 78, "Grande": 88 }
    },
    tags: ["aniversarios", "porque"],
    desc: `Escolha a massa, a cobertura e os toppings (granulados, disquete...).
    Disponível em três tamanhos para escolher o ideal:
Pequeno (15 cm), Médio (20 cm) e Grande (25 cm).`,

    imgs: [ "IMG/bolo vulcao7.jpg", "IMG/bolo vulcao5.jpg", "IMG/bolo vulcao1.jpg", "IMG/bolo vulcao6.jpg","IMG/bolo vulcao8.jpg"],
    options: [
      { key: "tamanho", label: "Tamanho", type: "select", required: true, choices: ["Pequeno", "Médio", "Grande"] },
      { key: "massa", label: "Massa", type: "select", required: true, choices: ["Baunilha", "Chocolate", "Cenoura", "Laranja"] },
      { key: "cobertura", label: "Cobertura", type: "select", required: true, choices: ["Brigadeiro", "Brigadeiro branco", "Doce de leite", "Ganache", "Ninho"] },
      { key: "toppings", label: "Toppings (escolha até 3)", type: "multiselect", required: false, max: 3, choices: ["Granulado", "Disquete", "Leite em pó", "Castanha", "Chocolate em pedaços", "Coco"] },
      { key: "restricoes", label: "Opções saudáveis (opcional) (+ R$ 18,00)", type: "multiselect", required: false, max: 3, choices: ["Sem glúten", "Sem lactose", "Sem açúcar"] },
    ],
  },
  ...
  // Bolo de pote
  {
    ...
    cat: "Doces",
    price: 18,
    tags: ["cafe", "porque", "presentes"],
    desc: `Porção individual, prática e deliciosa.
Aproximadamente 250 g. 
Escolha o recheio.`,
    imgs: ["IMG/bolode pote01.jpg", "IMG/bolode pote2.jpg", "IMG/bolode pote3.jpg"],
    options: [
      { key: "recheio", label: "Recheio", type: "select", required: true, choices: ["Limão", "Chocolate", "Chocolate branco e maracujá"] },
      { key: "restricoes", label: "Opções saudáveis (opcional) (+ R$ 18,00)", type: "multiselect", required: false, max: 3, choices: ["Sem glúten", "Sem lactose", "Sem açúcar"] },
    ],
  },
  ...
  // Torta
  {
    ...
    pricing: {
      fatia: 15,
      defaultSize: "Média",
      bolo: { "Pequena": 55, "Média": 65, "Grande": 75 }
    },
    tags: ["cafe", "presentes", "porque", "aniversarios"],
    desc: "Escolha o sabor e o formato da sua torta.",
    imgs: ["IMG/tortade limao2.jpg","IMG/tortade maracujafatia1.jpg", "IMG/tortasindex.jpg", "IMG/tortade maracuja.jpg"],
    options: [
      { key: "tipo", label: "Formato", type: "select", required: true, choices: ["Bolo", "Fatia"] },
      { key: "tamanho", label: "Tamanho", type: "select", required: false, requiredIf: { key: "tipo", value: "Bolo" }, choices: ["Pequena", "Média", "Grande"] },
      { key: "sabor", label: "Sabor", type: "select", required: true, choices: ["Limão", "Maracujá"] },
      { key: "restricoes", label: "Opções saudáveis (opcional) (+ R$ 18,00)", type: "multiselect", required: false, max: 3, choices: ["Sem glúten", "Sem lactose", "Sem açúcar"] },
    ],
  },
  ...
  // Doces
  {
    ...
    cat: "Doces",
    price: 3.5,
    tags: ["aniversarios", "presentes", "porque"],
    desc: `Doces clássicos de festa, vendidos por unidade. 
    Aproximadamente 20 g cada.`,
    imgs: ["IMG/docesvariadoscerto.jpg","IMG/casadinho.jpg", "IMG/brigadeiro.jpg", "IMG/beijinho.jpg", "IMG/moranguinho.jpg"],
    options: [{ key: "tipo", label: "Tipo", type: "select", required: true, choices: ["Brigadeiro", "Casadinho", "Moranguinho", "Beijinho"] }],
  },

  {
    id: "p07",
    name: "Mousse trufado (chocolate com maracujá)",
    cat: "Doces",
    price: 32,
    tags: ["presentes", "porque"],
    desc: `Chocolate com maracujá, textura cremosa e finalização trufada. 
    Aproximadamente 250 g.`,
    imgs: ["IMG/mousse trufado.jpg"],
    options: [{ key: "restricoes", label: "Opções saudáveis (opcional) (+ R$ 18,00)", type: "multiselect", required: false, max: 3, choices: ["Sem glúten", "Sem lactose", "Sem açúcar"] }],
  },
  ...
  // Trufas
  {
    ...
    cat: "Trufas",
    price: 5,
    tags: ["presentes", "porque", "cafe"],
    desc: `Trufas artesanais (aprox. 25 g por unidade). 
    Escolha o sabor.`,
    imgs: ["IMG/trufasindex.jpg","IMG/trufade limao.jpg", "IMG/trufade maracuja.jpg", "IMG/trufade morango.jpg"],
    options: [
      {
        key: "sabor",
        label: "Sabor",
        type: "select",
        required: true,
        choices: ["Maracujá", "Limão", "Chocolate", "Beijinho", "Castanha", "Doce de leite", "Morango", "Chocolate branco", "Ninho"],
      },
      { key: "restricoes", label: "Opções saudáveis (opcional) (+ R$ 18,00)", type: "multiselect", required: false, max: 3, choices: ["Sem glúten", "Sem lactose", "Sem açúcar"] },
    ],
  },
  ...
  {
    id: "p09",
    name: "Copo com frutas",
    cat: "Doces",
    price: 26,
    tags: ["cafe", "porque", "presentes"],
    desc: `Copo com frutas e recheio(s). 
    Escolha até 2 opções. Aproximadamente 250 g.`,
    imgs: ["IMG/copo da felicidade4.jpg","IMG/copo da felicidade3.jpg", "IMG/copo da felicidade2.jpg"],
    options: [
      { key: "recheioA", label: "Recheio (1)", type: "select", required: true, choices: ["Brigadeiro", "Brigadeiro branco"] },
      { key: "recheioB", label: "Recheio (2)", type: "select", required: true, choices: ["Brigadeiro", "Brigadeiro branco"], helper: "Pode repetir (ex.: Brigadeiro + Brigadeiro)." },
      { key: "restricoes", label: "Opções saudáveis (opcional) (+ R$ 18,00)", type: "multiselect", required: false, max: 3, choices: ["Sem glúten", "Sem lactose", "Sem açúcar"] },
    ],
  },
  ...
  // Pudim
{
  ...
  price: 12,
  tags: ["cafe", "porque", "presentes"],
  desc: `Fatia de pudim cremoso com calda. 
  Aproximadamente 120 g.`,
  imgs: ["IMG/fatiade pudim1.jpg", "IMG/fatiade pudim.jpg"],
  options: [
    { key: "restricoes", label: "Opções saudáveis (opcional) (+ R$ 18,00)", type: "multiselect", required: false, max: 3,
      choices: ["Sem glúten", "Sem lactose", "Sem açúcar"]
    },
  ],
},
  ...
  // Bolo pudim
  {
    ...
    pricing: {
      defaultSize: "Médio",
      bolo: { "Pequeno": 65, "Médio": 75, "Grande": 85 }
    },
    tags: ["aniversarios", "cafe", "porque"],
    desc: "Bolo com camada de pudim — textura cremosa e sabor marcante.",
    imgs: ["IMG/bolopudim.jpg", "IMG/bolopudim1.jpg"],
    options: [
    { key: "tipo", label: "Formato", type: "select", required: true, choices: ["Bolo", "Fatia"] },
    { key: "tamanho", label: "Tamanho", type: "select", required: false, requiredIf: { key: "tipo", value: "Bolo" }, choices: ["Pequena", "Média", "Grande"] },
    { key: "restricoes", label: "Opções saudáveis (opcional) (+ R$ 18,00)", type: "multiselect", required: false, max: 3, choices: ["Sem glúten", "Sem lactose", "Sem açúcar"] },
...
// Descrições dinâmicas (por produto/opção)
const DYNAMIC_DESCS = {
  p05: {
    Bolo: `Torta inteira, ideal para compartilhar.
Disponível em três tamanhos:
Pequena (20 cm), Média (24 cm) e Grande (28 cm).`,
    Fatia: `Fatia individual de torta, ideal para o café ou sobremesa.
Aproximadamente 120 g.`,
  },

  p11: {
    Bolo: `Bolo pudim inteiro, com camada cremosa de pudim e massa macia.
Disponível em três tamanhos:
Pequeno (15 cm), Médio (20 cm) e Grande (25 cm).`,
    Fatia: `Fatia individual de bolo pudim, cremosa e equilibrada.
Aproximadamente 120 g.`,
  },

  p02: {
    Bolo: `Bolo simples, fofinho e cheio de sabor.
Disponível em três tamanhos:
Pequeno (15 cm), Médio (20 cm) e Grande (25 cm).`,
    Fatia: `Fatia de bolo caseiro, ideal para o café.
Aproximadamente 120 g.`,
  },
};
...
function initProductDetail() {
  ...
  // ✅ Helper: aplica descrição dinâmica (ex.: Torta Bolo/Fatia)
  function applyDynamicDesc() {
    const dyn = (typeof DYNAMIC_DESCS === "object" && DYNAMIC_DESCS) ? DYNAMIC_DESCS[p.id] : null;
    if (!dyn) return;

    const tipo = String(optsState.tipo || "Bolo");
    const txt = dyn[tipo] || p.desc;
...
function initCheckoutPage() {
  ...
  // ✅ controla se o CEP foi validado no ViaCEP
  let cepValido = false;
  ...
  function getShipValue() {
    ...
    shipLine.textContent = ship.label;
    return ship.value;
  }
  ...
  form.addEventListener("submit", (e) => {
    ...
    // ✅ BLOQUEIA se o ViaCEP não validou
    if (!cepValido) {
    ...
    const ship = calcShipping(cepDigits);
    const subtotal = computeSubtotal(items);
